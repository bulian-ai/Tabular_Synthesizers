...
from ....metrics.single_table.efficacy.binary import BinaryEfficacyMetric
from ....metrics.single_table.efficacy.multiclass import MulticlassEfficacyMetric
from ....metrics.single_table.efficacy.regression import RegressionEfficacyMetric
...
class MLEfficacy(MLEfficacyMetric):
    ...
    goal = Goal.MAXIMIZE
    MetricType = MetricType.EFFICACY
    min_value = -np.inf
    max_value = np.inf
